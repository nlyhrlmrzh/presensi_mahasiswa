                            ...
                            <table class="w-full text-md bg-white shadow-md rounded mb-4">
                                ...
                                <tbody>
                                    <tr class="border-b hover:bg-orange-100 bg-gray-100">
                                        ...
                                        <td class="p-3 px-5"><input type="text" value="200101010" class="bg-transparent">
                                        </td>
                                        <td class="p-3 px-5"><input type="text" value="Hizriyan Amrulloh"
                                                class="bg-transparent"></td>
                                        <td class="p-3 px-5"><input type="text" value="Electrical Engineering"
                                                class="bg-transparent"></td>
                                        <td class="p-3 px-5"><input type="text" value="2020" class="bg-transparent">
                                        </td>
