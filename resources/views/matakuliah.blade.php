                            ...
                            <table class="w-full text-md bg-white shadow-md rounded mb-4">
                                ...
                                <tbody>
                                    <tr class="border-b hover:bg-orange-100 bg-gray-100">
                                        ...
                                        <td class="p-3 px-5"><input type="text" value="EL20" class="bg-transparent"></td>
                                        <td class="p-3 px-5"><input type="text" value="Robotika" class="bg-transparent"></td>
                                        <td class="p-3 px-5"><input type="text" value="Dr. Ihsan Imaduddin, S.Si., M.Si." class="bg-transparent"></td>
